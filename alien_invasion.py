...
#Bullet class imported
from bullet import Bullet 
#Alien class imported
from alien import Alien 
#GameStats class imported
from game_stats import GameStats
#Button class is imported
from button import Button
#Scoreboard class is imported
...
class AlienInvasion:
    ...
    def __init__(self):
        ...
        self.screen = pygame.display.set_mode((0,0),pygame.FULLSCREEN) #tuple that draws game dimension windows
    ...
    def _ship_hit(self):
        ...
        if self.stats.ships_left > 0:
            #Decrement ships left. and update scorevoard
    ...
    def _create_fleet(self):
        ...
        #creare the first row of aliens
    ...
    def _check_bullet_alien_collisions(self):
        ...
        if not self.aliens:
            ...
            self.bullets.empty()
            self._create_fleet()
            #after the last alien shot increase the speed
    ...
    def _check_play_button(self, mouse_pos):
        ...
        if button_clicked and not self.stats.game_active:
            ...
            #Get ridd of any remaining aliens and bullets.
            self.aliens.empty()
            self.bullets.empty()
